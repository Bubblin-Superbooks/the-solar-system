var renderer, scene, camera, controls, galaxy;

if (webglAvailable()) {
				setScene();
} else {
				var p = document.createElement('p');
				p.textContent = 'warning : your browser do not support webgl or webgl contexts creation fails for some reason. We may put an image or a video soon here at the place.'
...
function setScene() {
				...
				camera = new THREE.PerspectiveCamera(70, innerWidth / innerHeight, .5, 500);
				...
				setInterval(changeGalaxy, 15000);
				changeGalaxy();
				animate();
}
